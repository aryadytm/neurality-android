...
import com.wemadefun.neurality.utils.CONFIG_ADMOB_NATIVE_STATS
import javax.inject.Inject

class StatsNativeAd @Inject constructor() {

    fun getAdLoader(activity: Activity, templateView: TemplateView): AdLoader.Builder {
        return AdLoader.Builder(activity, CONFIG_ADMOB_NATIVE_STATS)
